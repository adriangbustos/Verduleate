...
@Component({
  selector: 'app-onboardingagricultor',
  standalone: true,
  imports: [
    CommonModule,
    FormsModule,
  ...
  templateUrl: './onboarding-agricultor.component.html',
  styleUrls: ['./onboarding-agricultor.component.css'],
  schemas: [CUSTOM_ELEMENTS_SCHEMA]
})
export class OnboardingAgricultorComponent implements AfterViewChecked, OnInit {
