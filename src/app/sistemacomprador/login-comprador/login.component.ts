...
export class LoginComponent {
  ...
  async recoverPassword() {
    try {
      ...
      await this.authService.sendRecoveryEmailCompradores(this.correo);
  ...
  async login() {
    if (this.loginForm.valid) {
      ...
      try {
        const user = await this.authService.signInCompradores(email, password);
        ...
        if (user) {
          ...
          const userDoc = await this.authService.getUserData(userId);
